...
function render(element: string): unknown;
function render(element: string, controller: ClientController): unknown;
function render(element: string, container: Element | null): unknown;
function render(
  element: string,
